...
@section('lead')
    ...
    <form action="{{ route('search.index') }}" method="get" name="search_master_form" autocomplete="off" id="search_master_form" class="flex mx-auto form p-5 bg-teal rounded shadow-md w-5/6">
        ...
        <div class="w-1/5 ml-4">
            <button class="w-full h-full btn bg-white">Szukaj</button>
        </div>
    </form>
@endsection
@section('content')
