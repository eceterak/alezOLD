<div class="mb-3 mb-lg-2">
    <ul class="list-group list-group-horizontal sort-group align-items-center small">
        ...
        <li class="list-group-item d-block d-lg-none ml-auto p-0"><button class="btn btn-sm btn-primary filters-show">Filtruj<i class="fas fa-filter fa-xs ml-1"></i></button></li>
    </ul>
</div>